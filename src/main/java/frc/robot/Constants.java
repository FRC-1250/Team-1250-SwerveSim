...
public class Constants {
    ...
    public static final double DEGRESS_TO_TALON_TICKS_CONVERSION_FACTOR = 11.4;
    ...
    public static final PIDGains DRIVE_TALON_VELOCITY_GAINS = new PIDGains(0.1, 0.001, 5, 1023.0 / 20660.0);
    public static final PIDGains TURNING_TALON_POSITION_GAINS = new PIDGains(0.50, 0.0, 1.0, 0.0);
    ...
    public static final double FRONT_LEFT_CANCODER_OFFSET = -52.758;
    ...
    public static final double FRONT_RIGHT_CANCODER_OFFSET = -83.320;
    ...
    public static final double REAR_LEFT_CANCODER_OFFSET = -95.889;
    ...
    public static final double REAR_RIGHT_CANCODER_OFFSET = 86;
